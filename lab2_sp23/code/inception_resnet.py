...
def InceptionResNetV1Norm(input_shape=(160, 160, 3),
    ...
    # Your code goes here
    scaleA = 0.17
    bltypeA = 'Inception_block_a'

    for blockIdx in range(1,6):
        x = resnet_block(x, scaleA, blockIdx, bltypeA)
    ...
    scaleB = 0.1
    bltypeB = 'Inception_block_b'

    for blockIdx in range(1,11):
        x = resnet_block(x, scaleB, blockIdx, bltypeB)
    ...
    # Your code goes here
    scaleC = 0.2
    bltypeC = 'Inception_block_c'

    for blockIdx in range(1,6):
        x = resnet_block(x, scaleC, blockIdx, bltypeC)
    ...
    # Please name all blocks properly to make it easy for your debugging
    x = GlobalAveragePooling2D()(x) # Your code goes here (do not modify the variable name assigned to)
    x = Dropout(1-dropout_keep_prob)(x)# Your code goes here (do not modify the variable name assigned to)
